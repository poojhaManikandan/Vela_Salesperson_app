...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('POS Billing Cart'),
        actions: [
          if (items.isNotEmpty)
            TextButton.icon(
              onPressed: () {
      ...
      body: SafeArea(
        child: items.isEmpty
            ? const EmptyState(
                ...
                title: 'Your billing cart is empty',
                subtitle:
                    'Select products from the POS shop screen to start billing.',
              )
            : ListView(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Billing Operator: ${CartStore.activeEmployee}',
                          ...
                          Row(
                            children: [
                              const Text('Presets: ', style: TextStyle(fontSize: 12, color: AppTheme.textMuted, fontWeight: FontWeight.w600)),
                              ActionChip(
                                label: const Text('Walk-in', style: TextStyle(fontSize: 11, color: AppTheme.primaryBlue, fontWeight: FontWeight.bold)),
                              ...
                              ActionChip(
                                label: const Text('Regular Client', style: TextStyle(fontSize: 11, color: AppTheme.primaryBlue, fontWeight: FontWeight.bold)),
                                visualDensity: VisualDensity.compact,
                                padding: EdgeInsets.zero,
                                onPressed: () {
                                  setState(() {
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              labelText: 'Customer Name / Business',
                              hintText: 'e.g. Walk-in Customer or Ramesh',
                            ...
                            children: [
                              ...
                              Wrap(
                                ...
                                children: [10, 20, 50].map((amt) {
                                  return ActionChip(
                                    label: Text('₹$amt', style: const TextStyle(fontSize: 11, color: AppTheme.primaryBlue, fontWeight: FontWeight.bold)),
                                    padding: EdgeInsets.zero,
                                    onPressed: () =>
